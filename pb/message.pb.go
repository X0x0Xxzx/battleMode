...
func (x *LoginNotice) GetPlayerId() string {
	if x != nil {
		return x.PlayerId
	}
	return ""
...
func (x *LoginNotice) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_proto_message_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x64, 0x22, 0x44, 0x0a, 0x0b, 0x4c, 0x6f,
	0x67, 0x69, 0x6e, 0x4e, 0x6f, 0x74, 0x69, 0x63, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6c, 0x61,
...
var file_proto_message_proto_goTypes = []interface{}{
	...
	(*LoginNotice)(nil), // 2: pb.LoginNotice
}
